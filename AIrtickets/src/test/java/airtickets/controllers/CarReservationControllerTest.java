...
public class CarReservationControllerTest {
	...
	private static final String PREFIX = "/carreservations";
	...
	@Transactional
	@Rollback(true)
	public void addCarReservation() throws Exception {
		
		String json = "{\r\n" + 
				"    \"id\": null,\r\n" + 
				"    \"vehicleId\": 21,\r\n" + 
				"    \"dateFrom\": \"2012-09-10T13:47:35\",\r\n" + 
				"    \"dateTo\": \"2012-09-30T00:20:20\",\r\n" + 
				"    \"price\": 22.0\r\n" + 
				"}";
		...
		mockMvc.perform(post(PREFIX + "/new").header("Authorization", "Bearer eyJhbGciOiJIUzUxMiJ9.eyJpc3MiOiJhaXJ0aWNrZXRzIiwic3ViIjoiYWRtaW4iLCJpYXQiOjE1Njc5ODc5MjAsImV4cCI6MTU2Nzk5NjkyMH0.NDa-EWvNX7IEU7Kmq26IetrG6SCpqNXb7xWQToOpK6WHoCSEdezo0WMFMBH0qHVT02LbOroSPI_oXaxY18sg8w")
				.contentType(contentType).content(json)).andExpect(status().isOk()).andExpect(jsonPath("$.price", is(22.0)));		
	}
}
